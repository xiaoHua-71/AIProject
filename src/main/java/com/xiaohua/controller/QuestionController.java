...
import com.xiaohua.model.dto.question.*;
...
public class QuestionController {
    ...
    @Resource
    private Scheduler vipSchedulers;
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(@RequestBody AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        //判断下标是否越界
        if (start == -1 || end == -1) {
            throw new RuntimeException("Invalid JSON format, '[' or ']' not found.");
        }
